...
function preload(){
  ...
  res2ini = loadAnimation ("images/resi 2 w weapon.png");
  res2wea = loadAnimation ("images/resi 2 w weapon.png");

  res3ini = loadAnimation ("images/resi 3 w weapon.png");
  res3wea = loadAnimation ("images/resi 3 w weapon.png");

  res4ini = loadAnimation ("images/resi 4 w weapon.png");
  res4wea = loadAnimation ("images/resi 4 w weapon.png");

  res5ini = loadAnimation ("images/resi 5 w weapon.png");
  res5wea = loadAnimation ("images/resi 5 w weapon.png");

  nanini = loadAnimation ("images/nan w weapon.png");
...
function draw() {
 ...
 // frasco.debug = true;
  ...
  res1.collide (solo);
  res1.setCollider ("rectangle", 40, 0, 5, 300);
  //res1.debug=true;

  res2.collide (solo);
  res2.setCollider ("rectangle", 40, 0, 5, 340);

  res3.collide (solo);
  res3.setCollider ("rectangle", 40, 0, 5, 240);

  res4.collide (solo);
  res4.setCollider ("rectangle", 40, 0, 5, 800);
  //res4.debug=true;

  res5.collide (solo);
  res5.setCollider ("rectangle", 40, 0,5, 800);

  nan.collide (solo);
  nan.setCollider ("rectangle", 40, 0, 5, 800);
...
if (keyDown(70)){
  window.location.replace ("https://youtu.be/eCOn1l7CUSA")
}
